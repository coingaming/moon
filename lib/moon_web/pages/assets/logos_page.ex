    ...
    <Page theme_name={@theme_name} active_page={@active_page} breadcrumbs={@breadcrumbs}>
      <TopToDown>
        ...
        <ExampleAndCode id="logo_9" class="mt-4">
          <:example>
            <Logo name="logo-comms-full" font_size="10rem" />
          </:example>
        ...
        <ExampleAndCode id="logo_11" class="mt-4">
          <:example>
            <Logo name="logo-drop" font_size="10rem" />
          </:example>
        ...
        <ExampleAndCode id="logo_14" class="mt-4">
          <:example>
            <Logo name="logo-lab-full" font_size="10rem" />
          </:example>
        ...
        <ExampleAndCode id="logo_19" class="mt-4">
          <:example>
            <Logo name="logo-missions" font_size="10rem" />
          </:example>
        ...
        <ExampleAndCode id="logo_20" class="mt-4">
          <:example>
            <Logo name="logo-moneyball" font_size="10rem" />
          </:example>
        ...
        <ExampleAndCode id="logo_22" class="mt-4">
          <:example>
            <Logo name="logo-moon-design" font_size="10rem" />
          </:example>
        ...
        <ExampleAndCode id="logo_23" class="mt-4">
          <:example>
            <Logo name="logo-paxful" font_size="10rem" />
          </:example>
        ...
        <ExampleAndCode id="logo_24" class="mt-4">
          <:example>
            <Logo name="logo-powered-by-hub88" font_size="10rem" />
          </:example>
        ...
        <ExampleAndCode id="logo_29" class="mt-4">
          <:example>
            <Logo name="logo-sportsbet-sponsor" font_size="10rem" />
          </:example>
        ...
        <ExampleAndCode id="logo_30" class="mt-4">
          <:example>
            <Logo name="logo-sportsbet" font_size="10rem" />
          </:example>
