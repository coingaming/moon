    ...
    <Page {=@theme_name} {=@active_page} {=@breadcrumbs} {=@direction}>
      <TopToDown>
        ...
        <ExampleAndCode id="pattern_1" class="mt-4">
          <:example>
            <Pattern name="pattern-circles" class="text-[10rem]" />
          </:example>
        ...
        <ExampleAndCode id="pattern_2" class="mt-4">
          <:example>
            <Pattern name="pattern-crosses" class="text-[10rem]" />
          </:example>
        ...
        <ExampleAndCode id="pattern_3" class="mt-4">
          <:example>
            <Pattern name="pattern-dotted" class="text-[10rem]" />
          </:example>
        ...
        <ExampleAndCode id="pattern_4" class="mt-4">
          <:example>
            <Pattern name="pattern-perspective-dotted" class="text-[10rem]" />
          </:example>
        ...
        <ExampleAndCode id="pattern_5" class="mt-4">
          <:example>
            <Pattern name="pattern-ripple" class="text-[10rem]" />
          </:example>
        ...
        <ExampleAndCode id="pattern_6" class="mt-4">
          <:example>
            <Pattern name="pattern-speed" class="text-[10rem]" />
          </:example>
        ...
        <ExampleAndCode id="pattern_7" class="mt-4">
          <:example>
            <Pattern name="pattern-wave" class="text-[10rem]" />
          </:example>
