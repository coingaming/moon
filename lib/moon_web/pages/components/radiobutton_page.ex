defmodule MoonWeb.Pages.Components.RadiobuttonPagexx do
  @moduledoc false
  ...
  alias Moon.Components.Radiobuttonxx
        ...
        <ExampleAndCode title="Radiobutton" id="radiobutton_1">
          <:example>
            <Form for={@user_changeset} change="register_form_update" submit="register_form_submit">
              <TopToDown>
                <Field name={:role}>
                  <Radiobuttonxx id="role_admin" value={1}>
                    Admin
                  </Radiobuttonxx>
                  <ErrorTag />
                </Field>
                <Field name={:role}>
                  <Radiobuttonxx id="role_editor" value={2}>
                    Editor
                  </Radiobuttonxx>
                  <ErrorTag />
                </Field>
                <Field name={:role}>
                  <Radiobuttonxx id="role_user" value={3} disabled>
                    User (disabled)
                  </Radiobuttonxx>
                  <ErrorTag />
                </Field>
