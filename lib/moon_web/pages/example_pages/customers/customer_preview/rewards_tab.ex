    ...
    ~F"""
      <div class="flex-1 h-full w-full">
        <div class="flex justify-between pt-6">
          ...
          <LeftToRight>
            <Button size="xsmall" variant="primary" right_icon="icon_chevron_down_rounded" class="rounded bg-goku-100 mr-4">
              <Text size="14">Release cashback</Text>
            </Button>

            <Button size="xsmall" variant="primary" right_icon="icon_chevron_down_rounded" class="rounded bg-goku-100">
