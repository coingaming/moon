defmodule MoonWeb.Pages.ExamplePages.LoginPage do
          ...
          <div id="login-form" class="w-full p-8 bg-goku-100 rounded shadow-sm">
            <Form for={:login_form} submit="login">
              ...
              <Button type="submit" class="w-full bg-whis-60">
                <span class="text-lg text-goten-100">Sign In</span>
              </Button>
            </Form>
  ...
  # Lifecycle methods
  #
  def mount(_params, %{"flask" => flask, "user_agent" => user_agent}, socket) do
    socket =
      socket
