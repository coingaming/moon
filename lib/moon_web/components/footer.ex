defmodule MoonWeb.Components.Footer do
  ...
  def render(assigns) do
    ~F"""
    <footer class="theme-moon-dark relative lg:fixed -mx-5 lg:mx-0 mt-16 lg:mt-0 z-50 lg:z-[9999] lg:bottom-0 inset-x-0 flex lg:flex-row gap-x-8 gap-y-6 2xl:ps-80 flex-wrap items-center text-moon-14 text-bulma bg-gohan justify-center md:justify-between">
