defmodule MoonWeb.Components.ExampleAndCode do
  ...
  def render(assigns) do
    ...
    <section class={"flex flex-col", @class}>
      <div class="flex flex-row items-center justify-between">
        <div class="flex flex-row gap-2 w-full">
          <Tabs id={"#{@id}-example-and-code"} class="justify-between gap-6">
            ...
            <Tabs.List class="w-fit p-1 gap-1 bg-gohan rounded-moon-s-md order-2">
            ...
            <Tabs.Panels class="order-4">
              ...
              <Tabs.Panel>
                <div class="overflow-scroll">
                  <pre class="theme-moon-dark w-full bg-gohan overflow-scroll p-4 text-moon-14 text-bulma rounded-moon-s-sm"><#slot {@code}>Example code not defined</#slot></pre>
                </div>
              </Tabs.Panel>
            </Tabs.Panels>
          </Tabs>
      ...
      <div
        class="theme-moon-dark grid gap-4 p-4 bg-gohan text-moon-14 rounded-moon-s-sm"
