defmodule MoonWeb.Components.VisionCard do
  ...
  def render(assigns) do
    ...
    <div class="flex flex-col 2xl:flex-row items-center gap-8 2xl:gap-18 3xl:gap-36">
      <div class="moon-design-dark flex flex-col items-center bg-goku-100 rounded-moon-s-lg gap-14 p-2">
        <div class="flex flex-col gap-14 max-w-lg items-end">
          <img src={@header_image} alt={@alt_header_image}>
          <p class="text-moon-16 max-w-md text-right text-trunks-100">
            {@subtext}
          </p>
        </div>
        <div class="flex flex-col rounded-moon-s-md py-6 px-8 gap-6 bg-gohan-100">
      ...
      <div class="flex flex-col gap-8 max-w-sm">
        ...
        <ul class="flex flex-col gap-4 text-moon-18 text-trunks-100 list-disc ms-6">
