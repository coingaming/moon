defmodule MoonWeb.Components.Facing.ForDesigners do
  ...
  def render(assigns) do
    ~F"""
    <div class="moon-design-dark text-bulma relative flex grow p-6 gap-6 theme-tokens rounded-moon-s-lg bg-for-designers 3xl:flex-col 3xl:h-96 3xl:w-80 3xl:rounded-br-none 3xl:absolute 3xl:top-0 ltr:3xl:right-80 rtl:3xl:left-80">
