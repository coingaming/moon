defmodule MoonWeb.Components.Facing.ForDesigners do
  ...
  def render(assigns) do
    ~F"""
    <div class="relative flex grow p-6 gap-6 theme-tokens rounded-moon-s-lg bg-for-designers text-gohan-100 3xl:flex-col 3xl:h-96 3xl:w-80 3xl:rounded-br-none 3xl:absolute 3xl:top-0 3xl:right-60">
      ...
      <div class="hidden flex-wrap gap-1 3xl:flex moon-design-dark bg-transparent">
        <a href="https://www.figma.com/community/file/1002945721703152933" target="_blank" rel="noreferrer">
