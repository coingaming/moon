defmodule MoonWeb.Examples.Design.PaginationExample.WithText do
  ...
  def code() do
    ...
    def render(assigns) do
      ~F\"""
      <Pagination id="default" total_pages={11} value={@current_page} on_change="set_current_page">
        <Pagination.PrevButton class="border-none font-regular" hover_class="group-hover:bg-none">Previous</Pagination.PrevButton>
        <Pagination.Pages />
        <Pagination.NextButton class="border-none font-regular" hover_class="group-hover:bg-none">Next</Pagination.NextButton>
      </Pagination>
      \"""
    end
