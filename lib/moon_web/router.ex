  ...
  live_session :default, on_mount: MoonWeb.Hooks.SetGlobalParams do
    Enum.each(["/", "/:theme_name/:direction"], fn theme_path ->
      scope theme_path do
        ...
        live("/components/v2/button/button", MoonWeb.Pages.Design.Button.ButtonPage)
        live("/components/v2/button/icon-button", MoonWeb.Pages.Design.Button.IconButtonPage)
