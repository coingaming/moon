defmodule Moon.Design.Chip do
  ...
  def render(assigns) do
    ...
    <button
      ...
      class={merge([
        [
          "z-0 overflow-hidden flex flex-row items-center text-moon-14 relative rounded-moon-i-sm cursor-pointer transition duration-200 space-between bg-goku text-bulma hover:bg-jiren hover:text-piccolo",
