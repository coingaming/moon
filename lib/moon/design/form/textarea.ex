defmodule Moon.Design.Form.Textarea do
  ...
  def render(assigns) do
    ~F"""
    <textarea class={merge(["appearance-none resize-none w-full p-4 text-moon-16 text-bulma bg-gohan",
      ...
      "hover:outline-offset-[-1px] hover:outline-bulma/[0.12]", @class])} {...@attrs}><#slot /></textarea>
    """
  end
end
