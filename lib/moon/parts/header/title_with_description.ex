defmodule Moon.Parts.Header.TitleWithDescription do
  ...
  def render(assigns) do
    ...
    <div
      ...
      class={merge([
        [
          "w-full text-bulma text-moon-24 font-grotesk p-4 md:p-8 md:not-first:pt-0 px-4 pb-6 pt-[5.5rem] flex flex-col gap-3",
          hidden: @is_hidden,
    ...
    >
      ...
      <p class={merge(["text-moon-16 md:text-moon-18 text-trunks", @description_class])}><#slot /></p>
    </div>
    """
  end
end
