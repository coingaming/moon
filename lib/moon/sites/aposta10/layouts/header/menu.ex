defmodule Moon.Sites.Aposta10.Layouts.Header.Menu do
  use Moon.StatelessComponent
  alias Moon.Sites.Aposta10.Layouts.Header.Menu.Link
  alias Moon.Sites.Aposta10.Layouts.Header.Menu.Separator
