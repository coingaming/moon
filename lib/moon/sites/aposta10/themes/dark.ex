...
defmodule Moon.Sites.Aposta10.Themes.Light.FontFace do
  defstruct 0: %Moon.Sites.Aposta10.Themes.Light.FontFace.0{},
    s1: %Moon.Sites.Aposta10.Themes.Light.FontFace.1{}
end
