  ...
  def render(assigns) do
    ...
    <div
      ...
      class={
        ...
        "rtl:left-[0.938rem]", # buggy on beta TW, rtl: and ltr: (Show password when using <TopToDown> is broken)
        "ltr:right-[0.938rem]", # buggy on beta TW, rtl: and ltr: (Show password when using <TopToDown> is broken)
        "right-[0.938rem]"
      }
    >
      <#slot />
