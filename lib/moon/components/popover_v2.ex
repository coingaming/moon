defmodule Moon.Components.PopoverV2 do
  ...
  def render(assigns) do
    ...
    <div class="relative inline-block">
      ...
      {#case @placement}
        {#match "top-start"}
          <div :if={@show} class="absolute top-0 left-0">
        ...
        {#match "top"}
          <div :if={@show} class="absolute left-0 top-0 right-0 flex flex-col items-center">
            <div class="transform -translate-y-full pb-2">
              <#slot name="content" />
            </div>
          </div>
        ...
        {#match "top-end"}
          <div :if={@show} class="absolute top-0 right-0">
            <div class="transform -translate-y-full pb-2">
              <#slot name="content" />
            </div>
          </div>
        ...
        {#match "bottom-start"}
          <div :if={@show} class="absolute left-0 bottom-0">
        ...
        {#match "bottom"}
          <div :if={@show} class="absolute left-0 bottom-0 right-0 flex flex-col items-center">
            <div class="transform translate-y-full pt-2">
              <#slot name="content" />
            </div>
          </div>
        ...
        {#match "bottom-end"}
          <div :if={@show} class="absolute right-0 bottom-0">
            <div class="transform translate-y-full pt-2">
              <#slot name="content" />
            </div>
          </div>
