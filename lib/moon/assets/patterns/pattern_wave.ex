defmodule Moon.Assets.Patterns.PatternWave do
  ...
  def render(assigns) do
    class_name =
      get_class_name("Patterns-PatternWave-#{assigns[:color]}-#{assigns[:background_color]}")
