defmodule Moon.Assets.Icons.IconCasino do
  ...
  def render(assigns) do
    class_name =
      get_class_name("Icons-IconCasino-#{assigns[:color]}-#{assigns[:background_color]}")
