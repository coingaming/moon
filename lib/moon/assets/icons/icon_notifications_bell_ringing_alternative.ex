defmodule Moon.Assets.Icons.IconNotificationsBellRingingAlternative do
  ...
  def render(assigns) do
    ...
    >
      <use href="/moon/assets/svgs/icons/icon-notifications-bell-ringing-alternative.svg#item" />
    </svg>
    """
  end
end
