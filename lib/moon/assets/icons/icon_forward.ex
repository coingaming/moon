defmodule Moon.Assets.Icons.IconForward do
  ...
  def render(assigns) do
    class_name =
      get_class_name("Icons-IconForward-#{assigns[:color]}-#{assigns[:background_color]}")
