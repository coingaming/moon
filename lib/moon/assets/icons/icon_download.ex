defmodule Moon.Assets.Icons.IconDownload do
  ...
  def render(assigns) do
    class_name =
      get_class_name("Icons-IconDownload-#{assigns[:color]}-#{assigns[:background_color]}")
