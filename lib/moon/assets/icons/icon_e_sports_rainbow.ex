defmodule Moon.Assets.Icons.IconESportsRainbow do
  ...
  def render(assigns) do
    class_name =
      get_class_name("Icons-IconESportsRainbow-#{assigns[:color]}-#{assigns[:background_color]}")
