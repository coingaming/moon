defmodule Moon.Assets.Icons.IconDelete do
  ...
  def render(assigns) do
    class_name =
      get_class_name("Icons-IconDelete-#{assigns[:color]}-#{assigns[:background_color]}")
