defmodule Moon.Assets.Icons.IconCurrencyMYR do
  ...
  def render(assigns) do
    class_name =
      get_class_name("Icons-IconCurrencyMYR-#{assigns[:color]}-#{assigns[:background_color]}")
