defmodule Moon.Assets.Icons.IconCurrencyINR do
  ...
  def render(assigns) do
    class_name =
      get_class_name("Icons-IconCurrencyINR-#{assigns[:color]}-#{assigns[:background_color]}")
