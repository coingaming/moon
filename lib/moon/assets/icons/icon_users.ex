defmodule Moon.Assets.Icons.IconUsers do
  ...
  def render(assigns) do
    class_name =
      get_class_name(
        "Icons-IconUsers-#{assigns.color}-#{assigns.background_color}-#{assigns.font_size}"
      )
