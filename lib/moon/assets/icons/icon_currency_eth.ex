defmodule Moon.Assets.Icons.IconCurrencyETH do
  ...
  def render(assigns) do
    class_name =
      get_class_name("Icons-IconCurrencyETH-#{assigns[:color]}-#{assigns[:background_color]}")
