defmodule Moon.Assets.Icons.IconESportsOverwatch do
  ...
  def render(assigns) do
    class_name =
      get_class_name(
        "Icons-IconESportsOverwatch-#{assigns[:color]}-#{assigns[:background_color]}"
      )
