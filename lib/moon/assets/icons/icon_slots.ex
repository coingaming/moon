defmodule Moon.Assets.Icons.IconSlots do
  ...
  def render(assigns) do
    class_name = get_class_name("Icons-IconSlots-#{assigns.color}-#{assigns.background_color}")
