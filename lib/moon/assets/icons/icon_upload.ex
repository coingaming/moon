defmodule Moon.Assets.Icons.IconUpload do
  ...
  def render(assigns) do
    class_name =
      get_class_name("Icons-IconUpload-#{assigns[:color]}-#{assigns[:background_color]}")
