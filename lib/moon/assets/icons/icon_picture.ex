defmodule Moon.Assets.Icons.IconPicture do
  ...
  def render(assigns) do
    class_name = get_class_name("Icons-IconPicture-#{assigns.color}-#{assigns.background_color}")
