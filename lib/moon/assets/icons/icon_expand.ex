defmodule Moon.Assets.Icons.IconExpand do
  ...
  def render(assigns) do
    class_name =
      get_class_name("Icons-IconExpand-#{assigns[:color]}-#{assigns[:background_color]}")
