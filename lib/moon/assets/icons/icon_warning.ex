defmodule Moon.Assets.Icons.IconWarning do
  ...
  def render(assigns) do
    class_name =
      get_class_name("Icons-IconWarning-#{assigns[:color]}-#{assigns[:background_color]}")
