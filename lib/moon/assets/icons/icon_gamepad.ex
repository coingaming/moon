defmodule Moon.Assets.Icons.IconGamepad do
  ...
  def render(assigns) do
    class_name =
      get_class_name("Icons-IconGamepad-#{assigns[:color]}-#{assigns[:background_color]}")
