defmodule Moon.Assets.Icons.IconSbShield do
  ...
  def render(assigns) do
    class_name = get_class_name("Icons-IconSbShield-#{assigns.color}-#{assigns.background_color}")
