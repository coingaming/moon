defmodule Moon.Assets.Icons.IconCursor do
  ...
  def render(assigns) do
    class_name =
      get_class_name("Icons-IconCursor-#{assigns[:color]}-#{assigns[:background_color]}")
