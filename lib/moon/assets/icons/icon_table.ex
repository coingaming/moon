defmodule Moon.Assets.Icons.IconTable do
  ...
  def render(assigns) do
    class_name = get_class_name("Icons-IconTable-#{assigns.color}-#{assigns.background_color}")
