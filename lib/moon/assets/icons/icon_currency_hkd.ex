defmodule Moon.Assets.Icons.IconCurrencyHKD do
  ...
  def render(assigns) do
    class_name =
      get_class_name("Icons-IconCurrencyHKD-#{assigns[:color]}-#{assigns[:background_color]}")
