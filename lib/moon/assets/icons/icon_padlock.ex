defmodule Moon.Assets.Icons.IconPadlock do
  ...
  def render(assigns) do
    class_name =
      get_class_name("Icons-IconPadlock-#{assigns[:color]}-#{assigns[:background_color]}")
