defmodule Moon.Assets.Icons.IconWalletRounded do
  ...
  def render(assigns) do
    class_name =
      get_class_name("Icons-IconWalletRounded-#{assigns[:color]}-#{assigns[:background_color]}")
