defmodule Moon.Assets.Icons.IconLogout do
  ...
  def render(assigns) do
    class_name =
      get_class_name("Icons-IconLogout-#{assigns[:color]}-#{assigns[:background_color]}")
