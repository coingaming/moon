defmodule Moon.Assets.Icons.IconChartRound do
  ...
  def render(assigns) do
    class_name =
      get_class_name("Icons-IconChartRound-#{assigns[:color]}-#{assigns[:background_color]}")
