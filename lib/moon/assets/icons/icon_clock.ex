defmodule Moon.Assets.Icons.IconClock do
  ...
  def render(assigns) do
    class_name =
      get_class_name("Icons-IconClock-#{assigns[:color]}-#{assigns[:background_color]}")
