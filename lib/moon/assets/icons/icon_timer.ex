defmodule Moon.Assets.Icons.IconTimer do
  ...
  def render(assigns) do
    class_name =
      get_class_name("Icons-IconTimer-#{assigns[:color]}-#{assigns[:background_color]}")
