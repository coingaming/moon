defmodule Moon.Assets.Icons.IconTelegram do
  ...
  def render(assigns) do
    class_name =
      get_class_name("Icons-IconTelegram-#{assigns[:color]}-#{assigns[:background_color]}")
