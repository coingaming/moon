defmodule Moon.Assets.Icons.IconMoon do
  ...
  def render(assigns) do
    class_name =
      get_class_name(
        "Icons-IconMoon-#{assigns.color}-#{assigns.background_color}-#{assigns.font_size}"
      )
